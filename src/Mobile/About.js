 ...
 render(){
    return <div><Fade cascade><div className={styles.aboutBlock}>
      ...
      <h3 className={styles.aboutBody}>
         At Ruatan Capital, we're increasing access to markets for retail and institutional investors by providing better prices, more liquidity, and the tools necessary to compete in the open market.
      </h3>
      ...
      <h3 className={styles.aboutBody2}>
      ...
      <h3 className={styles.aboutBody2}>At this time our team doesn't actively invest in directional strategies, 
